...
# DVE full session
# Saved on Tue Dec 5 22:42:09 2017
# Designs open: 1
...
#   Source.1: 
#   Group count = 6
#   Group top_tb signal count = 14
#   Group MAC1 signal count = 15
#   Group MAC2 signal count = 15
#   Group MAC2_1 signal count = 15
#   Group MAC2_1_1 signal count = 20
#   Group MAC1_1 signal count = 15
...
#<Session mode="Full" path="/home/warehouse/c.ricciardi/GitHub/ESE488_FinalProject/top/DVEfiles//crash_12.05-22.42/dve_session12.05-22.42.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{186 252} {1117 825}}
