...
# DVE full session
# Saved on Mon Dec 4 20:38:17 2017
# Designs open: 0
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{678 176} {1785 893}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 320} {child_wave_right 782} {child_wave_colname 158} {child_wave_colvalue 158} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 15813000
